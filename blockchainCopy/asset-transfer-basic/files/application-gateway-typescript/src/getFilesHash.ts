...
async function main(): Promise<void> {
  ...
  try {
    ...
    const result = await getFilesHash(contract);
...
async function getFilesHash(contract: Contract): Promise<string> {
  const resultBytes = await contract.evaluateTransaction('ReadAsset', argv.filename);
